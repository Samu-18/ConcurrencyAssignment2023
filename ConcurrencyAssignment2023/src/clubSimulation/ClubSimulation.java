...
public class ClubSimulation {
   ...
   /*static AtomicBoolean flags to control the simulation*/
       ...
       /*added the atomic start*/
		...
		startB.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e)  {
                  ...
                  /*The fix: set the flag to true when simulation starts*/
                  started.set(true);	  
		    }
		   });
		...
		JButton endB = new JButton("Quit");
				...
				endB.addActionListener(new ActionListener() {
			      public void actionPerformed(ActionEvent e) {
                  quit.set(true); /*set the flag to true when simulation ends*/
			    	  	System.exit(0);
			      }
			    });
